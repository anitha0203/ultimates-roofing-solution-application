...
return (
    <div>
        ...
        <Navbar expand="xxl" fixed="top">
            <Container fluid>
                <Navbar.Brand href="/" className='main-logo'><img className='logo-section' src={Logo} /></Navbar.Brand>
                <Navbar.Toggle
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <Nav className="justify-content-end flex-grow-1">
                        <Nav.Link href="/" style={{ marginTop: "0.6vh" }} className={`nav-link-with-margin not-active ${isNavLinkActive('/contact') ? 'active' : ''}`}><img src={PhoneIcon} className='phone-icon' />675-456-9786</Nav.Link>
